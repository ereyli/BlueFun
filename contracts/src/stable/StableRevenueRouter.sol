...
/// @notice Holds native 18-decimal USDT0 launch revenue until it is claimed to the BlueFun Safe.
contract StableRevenueRouter is TwoStepAdmin, ReentrancyGuard, IRevenueRouter {
    ...
    function claimTreasuryRevenue() external nonReentrant returns (uint256 amount) {
        ...
        if (address(this).balance < amount) revert Insolvent();
