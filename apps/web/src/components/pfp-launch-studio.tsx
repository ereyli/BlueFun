    ...
    <div className="nft-studio-layout">
      <section className="nft-form-card">
        ...
        <PFPSection active={step === 2} number="02" icon={<UploadCloud/>} title="Generative artwork & traits" detail="One unique image and metadata record per NFT — up to 10,000 items.">
          ...
          <p className="nft-field-note"><ShieldCheck/>Use filenames 1.png…N.png with 1.json…N.json, one metadata array JSON, or a CSV with token_id, name, description, image and trait:* columns. B20 securely shuffles the final token-to-art assignment before pinning and commits its provenance hash.</p>
