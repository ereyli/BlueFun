...
import { arcRpcUrls, baseRpcUrls, monadRpcUrls, robinhoodRpcUrls, stableRpcUrls } from "@/lib/rpc";
...
const sharedConfig = {
  chains: [baseChain, robinhoodChain, monadChain, stableChain, arcChain] as const,
  transports: {
